...
struct Student {
    ...
    Student(string id, string username, string password, string firstName, string lastName, string email)
    : id(id), username(username), password(password), firstName(firstName), lastName(lastName), email(email), classPtr(nullptr), Ipk() {}   
